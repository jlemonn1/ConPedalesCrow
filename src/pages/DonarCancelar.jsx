    ...
    <>
      ...
      <div className="donar-cancelar-page">
        <div className="cancelar-card">
          <div className="cancelar-icon-wrapper">
          ...
          <p className="cancelar-message">
            El proceso de pago fue cancelado. No te preocupes, no se ha realizado ningún cargo.
            Si tuviste algún problema, puedes intentarlo de nuevo cuando quieras.
          </p>
